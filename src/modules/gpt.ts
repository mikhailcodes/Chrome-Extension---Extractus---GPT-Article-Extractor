...
const summerizeArticle = async (content: any, complexity = 2) => {
    ...
    const propmpt = `You are a journalist. Summerize and provide ${bullet_number} bullet points and 1-2 sentences for each bullet point of the article content below. \n\n The article content is here: ${content}.`
